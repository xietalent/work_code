...
class Hagendasi():
    ...
    def get_cookie(self):
        ...
        print(type(cookies))
        with open(r'E:\code\spiders_three\cookie_bag\hagendasi_cook.txt', 'w') as fp:
    ...
    def req_hagendasi(self):
        ...
        with open(r"E:\code\spiders_three\text\hagendasi_info.txt", 'w', encoding="utf-8")  as fp:
            fp.write(tuniu_html.text)
            fp.close()
        print(tuniu_html.text)
        # my_info = tuniu_html.text

        with open(r"E:\code\spiders_three\text\hagendasi_info.txt", 'r', encoding="utf-8") as f:
            html = f.read()
