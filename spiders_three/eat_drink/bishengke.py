...
class Bishengke():
    ...
    def process_request(self):
        ...
        self.browser.get("http://www.pizzahut.com.cn/StoreList")
    ...
    def req_IHG(self):
        # 使用cookie模拟登录状态
        with open(r'E:\code\spiders_three\cookie_bag\bishengke_cook.txt', 'r', encoding='utf-8') as fp:
        ...
        url = "http://www.pizzahut.com.cn/HomePage/VIP"
        headers = {
            'cookie': cookie_str,
            'user-agent': 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/72.0.3626.121 Safari/537.36',
        }
        tuniu_html = requests.get(url=url, headers=headers)
        with open(r"E:\code\spiders_three\text\bishengke_info.txt", 'w', encoding="utf-8")  as fp:
            fp.write(tuniu_html.text)
            fp.close()
        print(tuniu_html.text)
        # my_info = tuniu_html.text

        with open(r"E:\code\spiders_three\text\bishengke_info.txt", 'r', encoding="utf-8") as f:
            html = f.read()
    ...
    def account_info(self):
        self.browser.get("http://www.pizzahut.com.cn/HomePage/VIP")
        with open(r'E:\code\spiders_three\cookie_bag\bishengke_cook.txt', 'r', encoding='utf-8') as fp:
            list_cookies = json.loads(fp.read())
