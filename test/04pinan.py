...
driver.get("https://bank.pingan.com.cn/m/main/index.html")


#查找页面上的,并且点击
# driver.find_element_by_link_text("")[0].click()
sleep(8)
# driver.find_element_by_link_text("密码登录")[0].click()
driver.find_element_by_class_name("selectMethod").click()
sleep(4)


imgcode = input("请输入验证码:")
sleep(2)
driver.find_element_by_id("userName").send_keys("6259691129820511")
driver.find_element_by_id("password").send_keys("zc006688")
