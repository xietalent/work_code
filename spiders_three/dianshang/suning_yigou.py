...
class Suning():
    ...
    def process_request(self):
        ...
        self.browser.get("https://passport.suning.com/ids/login?method=GET&loginTheme=b2c")
        usename, passwd = self.user_info()
        WebDriverWait(self.browser,5,1).until(EC.element_to_be_clickable((By.CLASS_NAME,"login-form")))
        # 普通登录
        self.browser.find_element_by_xpath("//div[@class='login-tab']/a[2]/span").click()
        sleep(0.5)
        try:
            ...
            #安全验证
            # self.browser.find_element_by_class_name("sncaptcha-init-button-text").click()
            # sleep(0.5)
    ...
    def get_cookie(self):
        ...
        print(type(cookies))
        with open(r'E:\code\spiders_three\cookie_bag\suning_cook.txt', 'w') as fp:
    ...
    def req_suning(self):
        # 使用cookie模拟登录状态
        with open(r'E:\code\spiders_three\cookie_bag\suning_cook.txt', 'r', encoding='utf-8') as fp:
        ...
        url = "https://my.suning.com/?safp=d488778a.homepage1.AVsm.1"
        headers = {
            'cookie': cookie_str,
            'user-agent': 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/72.0.3626.121 Safari/537.36',
        }
        tuniu_html = requests.get(url=url, headers=headers)
        with open(r"E:\code\spiders_three\text\suning_info.txt", 'w', encoding="utf-8")  as fp:
    ...
    def account_info(self):
        self.browser.get("https://my.suning.com/?safp=d488778a.homepage1.AVsm.1")
        with open(r'E:\code\spiders_three\cookie_bag\suning_cook.txt', 'r', encoding='utf-8') as fp:
            list_cookies = json.loads(fp.read())
        ...
        sleep(3)
        #我的金融
        self.browser.get("http://my.jr.suning.com/sfp/accountAssets/index.htm?")
        sleep(3)
        #我的优惠券
        self.browser.get("https://quan.suning.com/yhq.do#unknown")
        sleep(3)
