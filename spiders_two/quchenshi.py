...
class Aiqiyi(object):
    ...
    def process_request(self):
        ...
        self.browser.get("http://vip.watsons.com.cn/VIPPC/management/memberIndex.aspx#")
        username,passwd = self.user_info()
        try:
            WebDriverWait(self.browser, 8, 0.5).until(EC.element_to_be_clickable((By.ID, 'txtCardNo')))
        except:
