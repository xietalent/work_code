...
class Botao(object):
    ...
    def process_request(self):
        ...
        self.browser.get("http://www.wyn88.com/user/login.html")
        usename, passwd = self.user_info()
        WebDriverWait(self.browser,5,1).until(EC.element_to_be_clickable((By.CLASS_NAME,"lg_input")))
        # 选择登录方式
        ...
        if loginway == "1":
            try:
                ...
                sleep(0.1)
                self.browser.find_element_by_id("btnSign").click()
    ...
    def get_cookie(self):
        ...
        print(type(cookies))
        with open(r'E:\code\spiders_three\cookie_bag\gelin_cook.txt', 'w') as fp:
    ...
    def req_IHG(self):
        # 使用cookie模拟登录状态
        with open(r'E:\code\spiders_three\cookie_bag\gelin_cook.txt', 'r', encoding='utf-8') as fp:
        ...
        with open(r"E:\code\spiders_three\text\gelin_info.txt", 'w', encoding="utf-8")  as fp:
            fp.write(tuniu_html.text)
            fp.close()
        print(tuniu_html.text)
        # my_info = tuniu_html.text

        with open(r"E:\code\spiders_three\text\gelin_info.txt", 'r', encoding="utf-8") as f:
            html = f.read()
    ...
    def account_info(self):
        self.browser.get("http://www.998.com/UserCenter")
        with open(r'E:\code\spiders_three\cookie_bag\gelin_cook.txt', 'r', encoding='utf-8') as fp:
            list_cookies = json.loads(fp.read())
