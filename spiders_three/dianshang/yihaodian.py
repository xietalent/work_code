...
class Yihaodian():
    ...
    def process_request(self):
        ...
        self.browser.get("https://passport.yhd.com/passport/login_input.do")
        usename, passwd = self.user_info()
        WebDriverWait(self.browser,5,1).until(EC.element_to_be_clickable((By.ID,"un")))
        # 普通登录
        sleep(0.5)
        try:
            self.browser.find_element_by_id("un").send_keys(usename)
            sleep(0.1)
            #密码
    ...
    def get_cookie(self):
        ...
        print(type(cookies))
        with open(r'E:\code\spiders_three\cookie_bag\yihaodian_cook.txt', 'w') as fp:
            fp.write(json.dumps(cookies))
            fp.close()
        sleep(0.5)

    def req_yihaodian(self):
        # 使用cookie模拟登录状态
        with open(r'E:\code\spiders_three\cookie_bag\yihaodian_cook.txt', 'r', encoding='utf-8') as fp:
        ...
        url = "https://home.yhd.com/myyhdindex/index.do"
        headers = {
            'cookie': cookie_str,
            'user-agent': 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/72.0.3626.121 Safari/537.36',
        }
        tuniu_html = requests.get(url=url, headers=headers)
        with open(r"E:\code\spiders_three\text\yihaodian_info.txt", 'w', encoding="utf-8")  as fp:
    ...
    def account_info(self):
        self.browser.get("https://home.yhd.com/myyhdindex/index.do")
        with open(r'E:\code\spiders_three\cookie_bag\yihaodian_cook.txt', 'r', encoding='utf-8') as fp:
            list_cookies = json.loads(fp.read())
        ...
        sleep(3)
        #我的订单
        self.browser.get("https://home.yhd.com/order/toOrderList.do")
        sleep(3)
        #我的余额
        self.browser.get("https://home.yhd.com/myyhdbalance/index.do")
        sleep(3)
