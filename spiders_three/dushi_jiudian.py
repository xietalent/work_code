...
class Dushi(object):
    ...
    def process_request(self):
        ...
        self.browser.get("http://www.118inns.com/new/login.aspx")
        ...
        if loginway == "1":
            try:
                self.browser.find_element_by_id("cardCode1").send_keys(usename)
                sleep(0.1)
    ...
    def get_cookie(self):
        ...
        print(type(cookies))
        with open(r'E:\code\spiders_three\cookie_bag\dushi_cook.txt', 'w') as fp:
    ...
    def req_IHG(self):
        # 使用cookie模拟登录状态
        with open(r'E:\code\spiders_three\cookie_bag\dushi_cook.txt', 'r', encoding='utf-8') as fp:
        ...
        url = "http://www.118inns.com/new/Point.aspx"
        headers = {
            'cookie': cookie_str,
            'user-agent': 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/72.0.3626.121 Safari/537.36'
        }
        tuniu_html = requests.get(url=url, headers=headers)
        with open(r"E:\code\spiders_three\text\dushi_info.txt", 'w', encoding="utf-8")  as fp:
            fp.write(tuniu_html.text)
            fp.close()
        print(tuniu_html.text)
        # my_info = tuniu_html.text

        with open(r"E:\code\spiders_three\text\dushi_info.txt", 'r', encoding="utf-8") as f:
            html = f.read()
    ...
    def account_info(self):
        self.browser.get("http://www.118inns.com/new/Point.aspx")
        with open(r'E:\code\spiders_three\cookie_bag\dushi_cook.txt', 'r', encoding='utf-8') as fp:
            list_cookies = json.loads(fp.read())
        ...
        self.browser.get("http://www.118inns.com/new/Point.aspx")
        sleep(3)
        self.browser.get("http://www.998.com/UserCenter/MyCoupon")
        sleep(3)
        self.browser.get("http://www.998.com/UserCenter/MyCredits")
        #
        # self.browser
