...
class Dior(object):
    ...
    def process_request(self):
        ...
        self.browser.get("https://www.dior.cn/beauty/zh_cn/store/customer/account/login")
        usename, passwd = self.user_info()
        # WebDriverWait(self.browser,5,1).until(EC.element_to_be_clickable((By.ID,"email")))
        # 选择登录方式
        ...
        if loginway == "1":
            try:
                self.browser.find_element_by_xpath("//span[@class='tab-login']").click()
                sleep(0.2)
                self.browser.find_element_by_id("email").send_keys(usename)
                sleep(0.1)
                self.browser.find_element_by_id("pass").send_keys(passwd)
                sleep(0.1)
                self.browser.find_element_by_xpath("//button[@id='send2']/span/span").click()
    ...
    def get_cookie(self):
        ...
        print(type(cookies))
        with open(r'E:\code\spiders_three\cookie_bag\dior_cook.txt', 'w') as fp:
    ...
    def req_IHG(self):
        # 使用cookie模拟登录状态
        with open(r'E:\code\spiders_three\cookie_bag\dior_cook.txt', 'r', encoding='utf-8') as fp:
        ...
        url = "https://www.dior.cn/beauty/zh_cn/store/customer/account/edit/#/Main"
        headers = {
            'cookie': cookie_str,
    ...
    def account_info(self):
        # self.browser.get("https://www.dior.cn/beauty/zh_cn/store/customer/account/edit/#/Main")
        # with open(r'E:\code\spiders_three\cookie_bag\dior_cook.txt', 'r', encoding='utf-8') as fp:
        #     list_cookies = json.loads(fp.read())
        ...
        sleep(3)
        #我的订单
        self.browser.get("https://www.dior.cn/beauty/zh_cn/store/sales/order/history/#/Main")
        sleep(3)
        #积分
        self.browser.get("https://www.dior.cn/beauty/zh_cn/store/customer/account/#/Main")
